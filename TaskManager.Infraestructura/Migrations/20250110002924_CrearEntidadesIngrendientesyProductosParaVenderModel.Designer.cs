...
namespace TaskManager.Infraestructura.Migrations
{
    ...
    [Migration("20250110002924_CrearEntidadesIngrendientesyProductosParaVenderModel")]
    partial class CrearEntidadesIngrendientesyProductosParaVenderModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Dominio.Entidades.ProductosParaVenderModel", b =>
                {
                    ...
                    b.Property<int>("IngrendienteId")
                        .HasColumnType("int");

                    b.Property<int?>("IngrendientesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManager.Dominio.Entidades.ProductosParaVenderModel", b =>
                {
                    b.HasOne("TaskManager.Dominio.Entidades.IngrendientesModel", "Ingrendientes")
                        .WithMany()
                        .HasForeignKey("IngrendientesId");

                    b.Navigation("Ingrendientes");
                });
            ...
            modelBuilder.Entity("TaskManager.Dominio.Entidades.ProductosParaVenderModel", b =>
                {
                    b.Navigation("IngrendientesList");
                });
